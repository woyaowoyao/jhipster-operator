    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="gatewayApp.invoiceShipment.home.createOrEditLabel">
              <Translate contentKey="gatewayApp.invoiceShipment.home.createOrEditLabel">Create or edit a Shipment</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : shipmentEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="dateLabel" for="shipment-date">
                    <Translate contentKey="gatewayApp.invoiceShipment.date">Date</Translate>
                  </Label>
                  <AvInput
                    id="shipment-date"
                    type="datetime-local"
                ...
                <AvGroup>
                  <Label id="detailsLabel" for="shipment-details">
                    <Translate contentKey="gatewayApp.invoiceShipment.details">Details</Translate>
                  </Label>
                  <AvField id="shipment-details" type="text" name="details" />
                </AvGroup>
                <AvGroup>
                  <Label for="shipment-invoice">
                    <Translate contentKey="gatewayApp.invoiceShipment.invoice">Invoice</Translate>
                  </Label>
                  <AvInput id="shipment-invoice" type="select" className="form-control" name="invoiceId" required>
                    {invoices
