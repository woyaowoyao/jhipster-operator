  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="gatewayApp.invoiceShipment.detail.title">Shipment</Translate> [<b>{shipmentEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            ...
            <dd>{shipmentEntity.invoiceCode ? shipmentEntity.invoiceCode : ''}</dd>
          </dl>
